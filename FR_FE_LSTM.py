...
FR_data.drop(['Interaction_Wind_Solar_DE', 'Interaction_Wind_Solar_FR'], axis=1, inplace=True)
...
interaction_columns = scaled_df_interaction[['Solar_Wind_FR_interaction', 'Solar_Wind_DE_interaction']]
