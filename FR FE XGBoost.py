# -*- coding: utf-8 -*-
"""
Created on Thu Apr 10 12:05:23 2025
...
# Load the dataset 
Norlys_df = pd.read_excel("FE_FR_data.xlsx", sheet_name="Sheet1")
...
plt.plot(results_xgb.index, results_xgb['Actual'], label='Actual', linewidth=2,color='steelblue')
plt.plot(results_xgb.index, results_xgb['Predicted'], label='Predicted', linewidth=2,color='red')
